...
If you discover a security vulnerability in vision-core, please report it privately
via GitHub's Private Vulnerability Reporting:

1. Go to https://github.com/AIWander/vision-core/security
...
vision-core is under active development. Only the latest release receives security
fixes. Older releases are not supported.

## Scope

In scope:
- The vision-core binary/library and any bundled assets
